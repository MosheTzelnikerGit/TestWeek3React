...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user._id, username: user.username, organization: user.organization, region: user.region }, process.env.JWT_SECRET || 'default_secret', { expiresIn: '1h' });
